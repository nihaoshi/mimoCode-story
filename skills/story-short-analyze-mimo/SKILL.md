...
```bash
# 执行前验证
node skills/story-short-analyze-mimo/scripts/workflow-guard.js pre <step> <workflow_dir> <project_dir>

# 执行后验证
node skills/story-short-analyze-mimo/scripts/workflow-guard.js post <step> <workflow_dir>
```
