...
- 追踪：伏笔.md + 时间线.md + 角色状态.md + 上下文.md + 物资.md + 重复语句.md
- 设定：{世界观文件数} 个 + 文风.md + 关系.md + 题材定位.md
- 故事线：故事线_索引.md + 故事线_主线_*.md + 故事线_交叉点.md
- 跨卷追踪：跨卷伏笔.md + 跨卷角色弧线.md + 卷间过渡.md
