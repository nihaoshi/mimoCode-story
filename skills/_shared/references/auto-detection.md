...
node skills/story-long-write-mimo/scripts/consistency-check.js {project_dir}
node skills/story-long-write-mimo/scripts/style-lint.js 正文/第{N}章_*.md
node skills/story-long-write-mimo/scripts/foreshadow-check.js {project_dir}
```
